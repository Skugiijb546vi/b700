...
public class StaggeredGridLayoutManager extends AbstractC1066oOOo0Oo implements InterfaceC1078oOOo0oo0 {
    ...
    */
    ...
    public final Parcelable OooooOO() {
        ...
        if (c1328oOooo0O0 != null) {
            C1328oOooo0O0 obj = new C1328oOooo0O0();
        ...
        C1328oOooo0O0 obj2 = new C1328oOooo0O0();
    ...
    */
    ...
    public final void o00oO0o(Rect rect, int i, int i2) {
        ...
        try { java.lang.reflect.Method m = android.view.View.class.getDeclaredMethod("setMeasuredDimension", int.class, int.class); m.setAccessible(true); m.invoke(this.OooO0O0, OooO0oO, OooO0oO2); } catch (Exception e) {}
    }
