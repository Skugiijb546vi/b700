...
public interface IBAccountManagerService extends IInterface {
    public static final String DESCRIPTOR = "com.app.framework.core.system.accounts.IBAccountManagerService";
        ...
        public static class Proxy implements IBAccountManagerService {
            ...
            public boolean addAccountExplicitly(Account account, String str, Bundle bundle, int i) {
                ...
                try {
                    ...
                    _Parcel.writeTypedObject(obtain, bundle, 0);
                    obtain.writeInt(i);
                    this.mRemote.transact(Stub.TRANSACTION_addAccountExplicitly, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.readInt() != 0;
                } finally {
                    obtain2.recycle();
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                ...
                case TRANSACTION_addAccountExplicitly /* 9 */:
                    i3 = addAccountExplicitly((Account) _Parcel.readTypedObject(parcel, Account.CREATOR), parcel.readString(), (Bundle) _Parcel.readTypedObject(parcel, Bundle.CREATOR), parcel.readInt()) ? 1 : 0;
                    parcel2.writeNoException();
                    parcel2.writeInt(i3);
                    break;
                case 10:
                ...
                case TRANSACTION_removeAccountExplicitly /* 11 */:
                    i3 = removeAccountExplicitly((Account) _Parcel.readTypedObject(parcel, Account.CREATOR), parcel.readInt()) ? 1 : 0;
                    parcel2.writeNoException();
                    parcel2.writeInt(i3);
                    break;
                ...
                case TRANSACTION_accountAuthenticated /* 26 */:
                    i3 = accountAuthenticated((Account) _Parcel.readTypedObject(parcel, Account.CREATOR), parcel.readInt()) ? 1 : 0;
                    parcel2.writeNoException();
                    parcel2.writeInt(i3);
                    break;
                ...
                case TRANSACTION_addAccountExplicitlyWithVisibility /* 29 */:
                    i3 = addAccountExplicitlyWithVisibility((Account) _Parcel.readTypedObject(parcel, Account.CREATOR), parcel.readString(), (Bundle) _Parcel.readTypedObject(parcel, Bundle.CREATOR), parcel.readHashMap(getClass().getClassLoader()), parcel.readInt()) ? 1 : 0;
                    parcel2.writeNoException();
                    parcel2.writeInt(i3);
                    break;
                case TRANSACTION_setAccountVisibility /* 30 */:
                    i3 = setAccountVisibility((Account) _Parcel.readTypedObject(parcel, Account.CREATOR), parcel.readString(), parcel.readInt(), parcel.readInt()) ? 1 : 0;
                    parcel2.writeNoException();
                    parcel2.writeInt(i3);
                    break;
