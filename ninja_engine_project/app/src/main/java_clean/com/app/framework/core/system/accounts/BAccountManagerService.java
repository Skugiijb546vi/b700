package com.app.framework.core.system.accounts;
...
import com.app.framework.core.system.accounts.IBAccountManagerService;
...
import com.ninja.engine.InterfaceC1831ooOOooO;
...
public class BAccountManagerService extends IBAccountManagerService.Stub implements ISystemService, PackageMonitor {
    ...
    public class GetAccountsByTypeAndFeatureSession extends Session {
        ...
        @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session, android.accounts.IAccountAuthenticatorResponse
        ...
        @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session
        public void run() {
        ...
        public void sendResult() {
            ...
            if (responseAndClose != null) {
                try {
                    ...
                    if (Log.isLoggable(BAccountManagerService.TAG, 2)) {
                        responseAndClose.toString();
                    }
                    Bundle bundle = new Bundle();
                    bundle.putParcelableArray("accounts", accountArr);
                    responseAndClose.onResult(bundle);
                } catch (RemoteException unused) {
                    Log.isLoggable(BAccountManagerService.TAG, 2);
                }
            }
        }
    ...
    public abstract class Session extends IAccountAuthenticatorResponse.Stub implements IBinder.DeathRecipient, ServiceConnection {
        ...
        private boolean bindToAuthenticator(String str) {
            Objects.toString(BAccountManagerService.this.mAuthenticatorCache.authenticators.keySet());
            AuthenticatorInfo authenticatorInfo = BAccountManagerService.this.mAuthenticatorCache.authenticators.get(str);
            if (authenticatorInfo == null) {
                Log.isLoggable(BAccountManagerService.TAG, 2);
                return false;
            }
            String str2 = authenticatorInfo.serviceInfo.packageName;
        ...
        public boolean checkKeyIntent(int i, Intent intent) {
            ...
            try {
                ResolveInfo resolveActivity = BAccountManagerService.this.mPms.resolveActivity(intent, 0, null, this.mAccounts.userId);
                intent.toString();
        ...
        public void onResult(Bundle bundle) {
            ...
            this.mNumResults++;
            if (bundle != null) {
                Objects.toString(bundle.keySet());
            }
            if (bundle != null) {
            ...
            if (responseAndClose != null) {
                try {
                    ...
                    responseAndClose.onError(i, string);
                } catch (RemoteException unused) {
                    Log.isLoggable(BAccountManagerService.TAG, 2);
                }
            }
    ...
    public void completeCloningAccount(IAccountManagerResponse iAccountManagerResponse, final Bundle bundle, final Account account, BUserAccounts bUserAccounts, final int i) {
        new Session(bUserAccounts, iAccountManagerResponse, account.type, false, false, account.name, false) { // from class: com.app.framework.core.system.accounts.BAccountManagerService.8
            @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session, android.accounts.IAccountAuthenticatorResponse
    ...
    private String getCallingPackageName() {
        ...
        throw new IllegalArgumentException(AbstractC1230oOoOo0o.OooO0o(callingPid, "ProcessRecord is null, PID: "));
    }
    ...
    private static AuthenticatorDescription parseAuthenticatorDescription(Resources resources, String str, AttributeSet attributeSet) {
        InterfaceC1831ooOOooO OooO0O0 = AbstractC0694o0ooooo0.OooO0O0();
        TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, OooO0O0.AccountAuthenticator());
        try {
            String string = obtainAttributes.getString(OooO0O0.AccountAuthenticator_accountType().intValue());
            int resourceId = obtainAttributes.getResourceId(OooO0O0.AccountAuthenticator_label().intValue(), 0);
            int resourceId2 = obtainAttributes.getResourceId(OooO0O0.AccountAuthenticator_icon().intValue(), 0);
            int resourceId3 = obtainAttributes.getResourceId(OooO0O0.AccountAuthenticator_smallIcon().intValue(), 0);
            int resourceId4 = obtainAttributes.getResourceId(OooO0O0.AccountAuthenticator_accountPreferences().intValue(), 0);
            boolean z = obtainAttributes.getBoolean(OooO0O0.AccountAuthenticator_customTokens().intValue(), false);
    ...
    private void saveAllAccounts() {
        synchronized (this.mUserAccountsMap) {
            Parcel obtain = Parcel.obtain();
            C0131o00O0o c0131o00O0o = new C0131o00O0o(BEnvironment.getAccountsConf(), 2);
    ...
    @Override // com.app.framework.core.system.accounts.IBAccountManagerService
    ...
    public void addAccount(IAccountManagerResponse iAccountManagerResponse, final String str, final String str2, final String[] strArr, boolean z, Bundle bundle, int i) {
        ...
        if (!bundle2.containsKey(AccountManagerCompat.KEY_ANDROID_PACKAGE_NAME)) {
            bundle2.putString(AccountManagerCompat.KEY_ANDROID_PACKAGE_NAME, GmsCore.GMS_PKG);
        }
        Objects.toString(bundle2.keySet());
        new Session(getUserAccounts(i), iAccountManagerResponse, str, z, true, null, false, true) { // from class: com.app.framework.core.system.accounts.BAccountManagerService.4
            @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session
            public void run() {
    ...
    public void copyAccountToUser(final IAccountManagerResponse iAccountManagerResponse, final Account account, final int i, int i2) {
        ...
        if (userAccounts != null && userAccounts2 != null) {
            account.toString();
            new Session(userAccounts, iAccountManagerResponse, account.type, false, false, account.name, false) { // from class: com.app.framework.core.system.accounts.BAccountManagerService.2
                @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session, android.accounts.IAccountAuthenticatorResponse
                public void onResult(Bundle bundle) {
    ...
    public void editProperties(IAccountManagerResponse iAccountManagerResponse, final String str, boolean z, int i) {
        ...
        new Session(getUserAccounts(i), iAccountManagerResponse, str, z, true, null, false) { // from class: com.app.framework.core.system.accounts.BAccountManagerService.6
            @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session
            public void run() {
    ...
    public void getAccountByTypeAndFeatures(final IAccountManagerResponse iAccountManagerResponse, String str, String[] strArr, final int i) {
        ...
        if (ArrayUtils.isEmpty(strArr)) {
            ...
            new GetAccountsByTypeAndFeatureSession(userAccounts, new IAccountManagerResponse.Stub() { // from class: com.app.framework.core.system.accounts.BAccountManagerService.1
    ...
    public void getAuthToken(IAccountManagerResponse iAccountManagerResponse, final Account account, final String str, final boolean z, boolean z2, final Bundle bundle, int i) {
        ...
        AbstractC0809oO0OooOO.OooOO0("response cannot be null", iAccountManagerResponse != null);
        try {
            if (account == null) {
                ...
                if (!z3 && (readAuthTokenInternal = readAuthTokenInternal(userAccounts, account, str)) != null) {
                    ...
                    new Session(userAccounts, iAccountManagerResponse, account.type, z2, false, account.name, false) { // from class: com.app.framework.core.system.accounts.BAccountManagerService.3
                        @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session, android.accounts.IAccountAuthenticatorResponse
    ...
    public void getAuthTokenLabel(IAccountManagerResponse iAccountManagerResponse, final String str, final String str2, int i) {
        AbstractC0809oO0OooOO.OooOO0("accountType cannot be null", str != null);
        AbstractC0809oO0OooOO.OooOO0("authTokenType cannot be null", str2 != null);
        new Session(getUserAccounts(i), iAccountManagerResponse, str, false, false, null, false) { // from class: com.app.framework.core.system.accounts.BAccountManagerService.7
            @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session, android.accounts.IAccountAuthenticatorResponse
            public void onResult(Bundle bundle) {
                if (bundle == null) {
                    super.onResult(bundle);
    ...
    public void loadAuthenticatorCache(String str) {
        ...
        List<ResolveInfo> queryIntentServices = this.mPms.queryIntentServices(intent, 128, -1);
        ...
        generateServicesMap(queryIntentServices, this.mAuthenticatorCache.authenticators, new RegisteredServicesParser());
        Objects.toString(this.mAuthenticatorCache.authenticators.keySet());
    }
    ...
    public void removeAccountAsUser(IAccountManagerResponse iAccountManagerResponse, Account account, boolean z, int i) {
        AbstractC0809oO0OooOO.OooOO0("account cannot be null", account != null);
        AbstractC0809oO0OooOO.OooOO0("response cannot be null", iAccountManagerResponse != null);
    ...
    public void updateCredentials(IAccountManagerResponse iAccountManagerResponse, final Account account, final String str, boolean z, final Bundle bundle, int i) {
        ...
        new Session(getUserAccounts(i), iAccountManagerResponse, account.type, z, true, account.name, false, true) { // from class: com.app.framework.core.system.accounts.BAccountManagerService.5
            @Override // com.app.framework.core.system.accounts.BAccountManagerService.Session
            public void run() {
