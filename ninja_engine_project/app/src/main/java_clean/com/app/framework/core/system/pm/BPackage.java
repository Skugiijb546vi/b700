...
public class BPackage implements Parcelable {
    public static final Parcelable.Creator<BPackage> CREATOR = new Parcelable.Creator<BPackage>() { // from class: com.app.framework.core.system.pm.BPackage.1
    ...
    public static class IntentInfo implements Parcelable {
        public static final Parcelable.Creator<IntentInfo> CREATOR = new Parcelable.Creator<IntentInfo>() { // from class: com.app.framework.core.system.pm.BPackage.IntentInfo.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
        ...
        public IntentInfo(IntentInfo intentInfo) {
            ...
            this.nonLocalizedLabel = str == null ? null : str;
            this.icon = intentInfo.icon;
            this.logo = intentInfo.logo;
            this.banner = intentInfo.banner;
        }
    ...
    public static final class SigningDetails implements Parcelable {
        public static final Parcelable.Creator<SigningDetails> CREATOR = new Parcelable.Creator<SigningDetails>() { // from class: com.app.framework.core.system.pm.BPackage.SigningDetails.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        while (it2.hasNext()) {
            ...
            ArrayList<II> arrayList2 = next2.intents;
            if (arrayList2 != 0) {
        ...
        while (it3.hasNext()) {
            ...
            ArrayList<II> arrayList3 = next3.intents;
            if (arrayList3 != 0) {
        ...
        while (it4.hasNext()) {
            ...
            ArrayList<II> arrayList4 = next4.intents;
            if (arrayList4 != 0) {
        ...
        while (it5.hasNext()) {
            ...
            ArrayList<II> arrayList5 = next5.intents;
            if (arrayList5 != 0) {
        ...
        while (it6.hasNext()) {
            ...
            ArrayList<II> arrayList6 = next6.intents;
            if (arrayList6 != 0) {
        ...
        while (it7.hasNext()) {
            ...
            ArrayList<II> arrayList7 = next7.intents;
            if (arrayList7 != 0) {
