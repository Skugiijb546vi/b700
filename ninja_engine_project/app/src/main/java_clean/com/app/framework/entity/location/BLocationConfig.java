package com.app.framework.entity.location;
...
public class BLocationConfig implements Parcelable {
    public static final Parcelable.Creator<BLocationConfig> CREATOR = new Parcelable.Creator<BLocationConfig>() { // from class: com.app.framework.entity.location.BLocationConfig.1
