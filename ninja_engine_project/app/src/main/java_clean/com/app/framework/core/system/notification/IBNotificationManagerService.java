...
public interface IBNotificationManagerService extends IInterface {
    public static final String DESCRIPTOR = "com.app.framework.core.system.notification.IBNotificationManagerService";
    ...
    public static abstract class Stub extends Binder implements IBNotificationManagerService {
        ...
        public static class Proxy implements IBNotificationManagerService {
            ...
            public void cancelNotificationWithTag(int i, String str, int i2) {
                ...
                try {
                    ...
                    obtain.writeInt(i2);
                    this.mRemote.transact(Stub.TRANSACTION_cancelNotificationWithTag, obtain, obtain2, 0);
            ...
            public NotificationChannel getNotificationChannel(String str, int i) {
                ...
                try {
                    ...
                    return Oooo0.OooO0O0(_Parcel.readTypedObject(obtain2, creator));
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
                }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                ...
                case 4:
                    creator = NotificationChannel.CREATOR;
                    createNotificationChannel(Oooo0.OooO0O0(_Parcel.readTypedObject(parcel, creator)), parcel.readInt());
                    parcel2.writeNoException();
                    break;
                case 5:
                ...
                case 6:
                    ...
                    createNotificationChannelGroup(Oooo0.OooO0Oo(_Parcel.readTypedObject(parcel, creator2)), parcel.readInt());
                    parcel2.writeNoException();
                    break;
                case 7:
