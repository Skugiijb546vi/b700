                ...
                try {
                    ...
                    cardView.setOnClickListener(new View.OnClickListener() { // from class: com.ninja.engine.oOOoo0OO
                        ...
                        public final void onClick(View view) {
                            try {
                                c1119oOOoo0oO.Oooo0o0(new Intent("android.intent.action.VIEW", Uri.parse(jSONObject2.getString("telegram"))));
                    ...
                    cardView2.setOnClickListener(new View.OnClickListener() { // from class: com.ninja.engine.oOOoo0OO
                        ...
                        public final void onClick(View view) {
                            try {
                                c1119oOOoo0oO.Oooo0o0(new Intent("android.intent.action.VIEW", Uri.parse(jSONObject2.getString("technical_support"))));
