...
public abstract class o0O0OO0 {
    ...
    public static int OooO0O0(int i, int i2) {
        ...
        return Color.argb(i3, OooO0OO(Color.red(i), alpha2, Color.red(i2), alpha, i3), OooO0OO(Color.green(i), alpha2, Color.green(i2), alpha, i3), OooO0OO(Color.blue(i), alpha2, Color.blue(i2), alpha, i3));
    }
