            ...
            if (OooO0O02.OooO(textInputLayout.getBoxBackgroundMode())) {
                ...
                if (OooO0oo != null && accessibilityManager != null) {
                    ...
                    if (isAttachedToWindow()) {
                        accessibilityManager.addTouchExplorationStateChangeListener(new accessibility_AccessibilityManager$TouchExplorationStateChangeListenerC0029OooOooo(this.OooOo0));
                    }
                }
