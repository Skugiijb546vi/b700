    ...
    public final void run() {
        switch (this.OooO00o) {
            ...
            case 2:
                ...
                return;
            case 3:
                BLocationManagerService.lambda$addTask$0((IInterface) this.OooO0O0, (BLocation) this.OooO0OO);
                return;
            case 4:
                ((BLocationManagerService) this.OooO0O0).lambda$addTask$1((IBinder) this.OooO0OO);
                return;
            case 5:
