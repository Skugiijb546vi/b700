...
public abstract class AbstractC0242o00oOoO0 {
    public static final AtomicReference OooO00o = new AtomicReference();

    public static MappedByteBuffer OooO00o(File file) {
    ...
    public static ByteBuffer OooO0O0(InputStream inputStream) {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(16384);
        AtomicReference atomicReference = OooO00o;
    ...
    public static void OooO0Oo(ByteBuffer byteBuffer, File file) {
        RandomAccessFile randomAccessFile;
        OooO0OO(byteBuffer);
        FileChannel fileChannel = null;
        try {
