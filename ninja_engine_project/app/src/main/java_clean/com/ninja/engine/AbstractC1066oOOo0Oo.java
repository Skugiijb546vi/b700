...
public abstract class AbstractC1066oOOo0Oo {
    ...
    */
    ...
    public static C1067oOOo0Oo0 Oooo0(Context context, AttributeSet attributeSet, int i, int i2) {
        C1067oOOo0Oo0 obj = new C1067oOOo0Oo0();
    ...
    */
    ...
    public void o00oO0o(Rect rect, int i, int i2) {
        ...
        RecyclerView recyclerView = this.OooO0O0;
        WeakHashMap weakHashMap = AbstractC1460oo0O00oo.OooO00o;
        try { java.lang.reflect.Method m = android.view.View.class.getDeclaredMethod("setMeasuredDimension", int.class, int.class); m.setAccessible(true); m.invoke(this.OooO0O0, OooO0oO(i, Oooo000, recyclerView.getMinimumWidth()), OooO0oO(i2, OooOooO, this.OooO0O0.getMinimumHeight())); } catch (Exception e) {}
    }
