...
public class C1741ooOO extends AbstractComponentCallbacksC0593o0oOoOo0 {
    ...
    public final View OooOo0O(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        if (!string.isEmpty()) {
            try {
                ...
                while (i2 < jSONArray.length()) {
                    ...
                    int i3 = i2 + 1;
                    arrayList.add(new o00O0O(optString, jSONObject.optString("name", "Profile " + i3), jSONObject.optString("id", "â€”"), jSONObject.optInt("userId", i2)));
                    i2 = i3;
                }
        ...
        if (arrayList.isEmpty()) {
            this.o000oOoO.add(new o00O0O("Google", "Profile 1", "â€”", 0));
        }
