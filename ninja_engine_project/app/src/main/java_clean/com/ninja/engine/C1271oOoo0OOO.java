            ...
            if (eventType != r4) {
                if (eventType != i) {
                    ...
                    if (equals) {
                        ...
                        c1269oOoo0OO.OooO0o = obtainStyledAttributes.getBoolean(2, true);
                        c1269oOoo0OO.OooO0oO = obtainStyledAttributes.getBoolean(0, true);
                        ...
                        if (obtainStyledAttributes2.hasValue(11)) {
                            c1269oOoo0OO.OooOOo = obtainStyledAttributes2.getBoolean(11, false) ? 1 : 0;
                        } else {
                            c1269oOoo0OO.OooOOo = c1269oOoo0OO.OooO0o0;
                        }
                        c1269oOoo0OO.OooOOoo = obtainStyledAttributes2.getBoolean(3, false);
                        c1269oOoo0OO.OooOo00 = obtainStyledAttributes2.getBoolean(4, c1269oOoo0OO.OooO0o != false);
                        c1269oOoo0OO.OooOo0 = obtainStyledAttributes2.getBoolean(1, c1269oOoo0OO.OooO0oO != false);
