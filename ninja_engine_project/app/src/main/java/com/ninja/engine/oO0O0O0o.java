...
public final class oO0O0O0o {
    ...
    static {
        Enum r7 = new Enum("ON_CREATE", 0);
        ON_CREATE = r7;
        Enum r8 = new Enum("ON_START", 1);
        ON_START = r8;
        Enum r9 = new Enum("ON_RESUME", 2);
        ON_RESUME = r9;
        Enum r10 = new Enum("ON_PAUSE", 3);
        ON_PAUSE = r10;
        Enum r11 = new Enum("ON_STOP", 4);
        ON_STOP = r11;
        Enum r12 = new Enum("ON_DESTROY", 5);
        ON_DESTROY = r12;
        Enum r13 = new Enum("ON_ANY", 6);
        ON_ANY = r13;
