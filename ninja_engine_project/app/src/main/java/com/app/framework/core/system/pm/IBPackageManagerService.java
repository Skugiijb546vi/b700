...
public interface IBPackageManagerService extends IInterface {
    public static final String DESCRIPTOR = "com.app.framework.core.system.pm.IBPackageManagerService";
        ...
        public static class Proxy implements IBPackageManagerService {
            ...
            public ActivityInfo getActivityInfo(ComponentName componentName, int i, int i2) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    this.mRemote.transact(Stub.TRANSACTION_getActivityInfo, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public List<ApplicationInfo> getInstalledApplications(int i, int i2) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    this.mRemote.transact(Stub.TRANSACTION_getInstalledApplications, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public List<PackageInfo> getInstalledPackages(int i, int i2) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    this.mRemote.transact(Stub.TRANSACTION_getInstalledPackages, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public List<ResolveInfo> queryBroadcastReceivers(Intent intent, int i, String str, int i2) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeInt(i2);
                    this.mRemote.transact(Stub.TRANSACTION_queryBroadcastReceivers, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public List<ResolveInfo> queryIntentServices(Intent intent, int i, int i2) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    this.mRemote.transact(Stub.TRANSACTION_queryIntentServices, obtain, obtain2, 0);
                    obtain2.readException();
                    return obtain2.createTypedArrayList(ResolveInfo.CREATOR);
                } finally {
                    obtain2.recycle();
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            ...
            switch (i) {
                ...
                case 10:
                    ...
                    _Parcel.writeTypedObject(parcel2, resolveService, 1);
                    break;
                case TRANSACTION_getInstalledApplications /* 11 */:
                    ...
                    break;
                case TRANSACTION_getInstalledPackages /* 12 */:
                    installedApplications = getInstalledPackages(parcel.readInt(), parcel.readInt());
                    parcel2.writeNoException();
                    _Parcel.writeTypedList(parcel2, installedApplications, 1);
                    break;
                case TRANSACTION_queryIntentActivities /* 13 */:
                    ...
                    _Parcel.writeTypedList(parcel2, installedApplications, 1);
                    break;
                case TRANSACTION_queryBroadcastReceivers /* 14 */:
                    ...
                    _Parcel.writeTypedList(parcel2, installedApplications, 1);
                    break;
                case TRANSACTION_queryIntentServices /* 15 */:
