...
public final class BUserHandle implements Parcelable {
    ...
    public static final Parcelable.Creator<BUserHandle> CREATOR = new Parcelable.Creator<BUserHandle>() { // from class: com.app.framework.core.system.user.BUserHandle.1
    ...
    public static int getUid(int i, int i2) {
        return (i2 % PER_USER_RANGE) + (i * PER_USER_RANGE);
    }
    ...
    public static int parseUserArg(String str) {
        ...
        if (!"current".equals(str) && !"cur".equals(str)) {
            try {
                ...
                throw new IllegalArgumentException(AbstractC1230oOoOo0o.OooOO0o("Bad user number: ", str));
            }
        }
        return -2;
    }
    ...
    public static int getCacheAppGid(int i, int i2) {
        ...
        return getUid(i, i2 + AID_APP_START);
    }
