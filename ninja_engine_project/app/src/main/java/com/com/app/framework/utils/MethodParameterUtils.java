...
public class MethodParameterUtils {
    ...
    public static void replaceAllAppPkg(Object[] objArr) {
        ...
        for (int i = 0; i < objArr.length; i++) {
            ...
            if (obj != null && (obj instanceof String)) {
                if (BlackBoxCore.get().isInstalled((String) obj, BlackBoxCore.getUserId())) {
    ...
    public static String replaceFirstAppPkg(Object[] objArr) {
        ...
        for (int i = 0; i < objArr.length; i++) {
            ...
            if (obj instanceof String) {
                ...
                if (BlackBoxCore.get().isInstalled(str, BlackBoxCore.getUserId())) {
                    objArr[i] = BlackBoxCore.getHostPkg();
                    return str;
                }
            }
    ...
    public static void replaceFirstUid(Object[] objArr) {
        ...
        for (int i = 0; i < objArr.length; i++) {
            Object obj = objArr[i];
            if ((obj instanceof Integer) && ((Integer) obj).intValue() == BlackBoxCore.getBUid()) {
    ...
    public static void replaceLastUid(Object[] objArr) {
        ...
        if (indexOfLast == -1 || ((Integer) objArr[indexOfLast]).intValue() != BlackBoxCore.getBUid()) {
            return;
        }
