...
public class ComponentResolver {
    ...
    private final ActivityIntentResolver mActivities = new ActivityIntentResolver(0);
    private final ProviderIntentResolver mProviders = new ProviderIntentResolver(0);
    private final ActivityIntentResolver mReceivers = new ActivityIntentResolver(0);
    private final ServiceIntentResolver mServices = new ServiceIntentResolver(0);
    ...
    public static final class ActivityIntentResolver extends IntentResolver<BPackage.ActivityIntentInfo, ResolveInfo> {
        ...
        @Override // com.app.framework.core.system.pm.IntentResolver
            ...
            if (str != null) {
                ...
                for (String str2 : split) {
                    if (this.mProvidersByAuthority.containsKey(str2)) {
                        ...
                        String str3 = bPackage.applicationInfo.packageName;
                    } else {
