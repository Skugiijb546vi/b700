...
public class BPackageSettings implements Parcelable {
    ...
    public static final Parcelable.Creator<BPackageSettings> CREATOR = new Parcelable.Creator<BPackageSettings>() { // from class: com.app.framework.core.system.pm.BPackageSettings.1
