...
public final class FragmentContainerView extends FrameLayout {
    ...
    public final WindowInsets dispatchApplyWindowInsets(WindowInsets windowInsets) {
        ...
        if (onApplyWindowInsetsListener != null) {
            ...
            AbstractC0809oO0OooOO.OooOOOO(onApplyWindowInsets, "onApplyWindowInsetsListe…lyWindowInsets(v, insets)");
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, C0606o0oOoooO c0606o0oOoooO) {
        ...
        if (classAttribute != null && OooOoOO == null) {
            ...
            AbstractC0809oO0OooOO.OooOOOO(OooO00o, "fm.fragmentFactory.insta…ontext.classLoader, name)");
            OooO00o.OooOoo = true;
