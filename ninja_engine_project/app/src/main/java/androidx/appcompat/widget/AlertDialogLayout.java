...
public class AlertDialogLayout extends AbstractC1159oOo00OOO {
    ...
    public static int OooOO0(View view) {
        ...
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return OooOO0(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            com.ninja.engine.oO0O0oo0 r6 = (com.ninja.engine.C0765oO0O0oo0) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r2
        L73:
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0765oO0O0oo0).width == -1) {
                        int i13 = ((LinearLayout.LayoutParams) c0765oO0O0oo0).height;
                        ((LinearLayout.LayoutParams) c0765oO0O0oo0).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i2, 0);
                        ((LinearLayout.LayoutParams) c0765oO0O0oo0).height = i13;
                    }
                }
            }
        }
